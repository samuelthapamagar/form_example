...
class PostRequestPage extends ConsumerStatefulWidget {
  ...
  @override
  _PostRequestPage createState() => _PostRequestPage();
}

class _PostRequestPage extends ConsumerState<PostRequestPage> {
              ...
              child: Container(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    ref.read(formProvider).postForms(requestBody: requestBody);
                    Navigator.push(
                        context,
                        MaterialPageRoute(
